...
class BaseGameScreenViewModel(
    ...
    fun dismissMenuAndEnterEditMode() {
        // Close edit controls submenu
        touchControls.showEditControls(false)
        // Dismiss main game menu by simulating menu button release
        touchControls.dismissMenu()
    }
    ...
    fun updateButtonCustomization(
        ...
        touchControls.updateButtonCustomization(buttonId, customization)
    }
