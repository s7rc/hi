...
abstract class LemuroidApplicationModule {
    ...
    companion object {
        ...
        @PerApp
        @JvmStatic
        fun touchControllerSettingsManager(sharedPreferences: Lazy<SharedPreferences>) =
            com.swordfish.touchinput.radial.settings.TouchControllerSettingsManager(sharedPreferences.get())
