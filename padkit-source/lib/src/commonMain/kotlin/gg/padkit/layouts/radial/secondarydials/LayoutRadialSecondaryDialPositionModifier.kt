...
internal class LayoutRadialSecondaryDialPositionModifier(
    private val positionInDegrees: Float,
) : ParentDataModifier {
    override fun Density.modifyParentData(parentData: Any?): Any {
        val currentData =
            (parentData as? LayoutRadialSecondaryDialProperties)
                ?: LayoutRadialSecondaryDialProperties()
        return currentData.copy(positionInDegrees = positionInDegrees)
    }
}
