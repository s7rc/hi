    ...
    BoxWithConstraints(
        ...
        modifier =
            modifier.drawWithCache {
                ...
                val modShadowColor = shadowColor.copy(alpha = shadowColor.alpha * opacity)
                // Disable shadow if opacity is reduced to avoid clipping artifacts
                val shouldDrawShadow = modShadowColor.alpha > 0f && blurRadiusPx > 0f && opacity >= 0.99f
