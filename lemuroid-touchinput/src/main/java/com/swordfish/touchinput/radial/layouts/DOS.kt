...
fun PadKitScope.DOSLeft(
    ...
    BaseLayoutLeft(
        ...
        secondaryDials = {
            ...
            SecondaryButtonSelect(settings, position = 2)
            SecondaryAnalogLeft(settings)
            LemuroidControlButton(
                modifier = Modifier.radialPosition(
...
fun PadKitScope.DOSRight(
    ...
    BaseLayoutRight(
        ...
        secondaryDials = {
            ...
            SecondaryButtonStart(settings, position = 2)
            SecondaryAnalogRight(settings)
